...
import { Star, BadgeCheck, MapPin, Table2, Armchair, Layers, Flower2, BookOpen, Sofa, BedDouble, Archive, Lamp, Frame } from "lucide-react";
...
export const CategoryCard = memo(function CategoryCard({
  ...
  const ICON_MAP: Record<string, typeof Table2> = {
    Table2, Armchair, Lamp, Layers, Frame, Archive, Sofa, BedDouble,
  };
